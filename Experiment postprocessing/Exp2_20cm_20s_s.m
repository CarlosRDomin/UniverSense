...
data = loadRealExperimentData(struct('datetime',{'2017-10-05 17-54-21'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-05 17-54-21/log_experiment_running_80_2017-10-05_17-54-21.npz']);
...
matchingPrint
save('slow2_20cm_20s.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
