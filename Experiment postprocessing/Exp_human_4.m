...
data = loadRealExperimentData(struct('datetime',{'2017-10-11 21-36-41'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-11 21-36-41/log_experiment_running_80_2017-10-11_21-36-41.npz']);
...
matchingPrint
similarity
save('human_4.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
