...
data = loadRealExperimentData(struct('datetime',{'2017-10-04 22-22-49'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-04 22-22-49/log_experiment_running_80_2017-10-04_22-22-49.npz']);
expStart = exp.tFloat(exp.measured == 1);
expStop = exp.tFloat(exp.measured == 0);
expStop(1) = [];
cameraIdxOffset = 0.2;
eventPadding = 0;
UAVgravityFactor = 7.9;%9.81;
axisCount = 0;
...
for strAxCell = {'Y', 'Z'}
    ...
    figure;
    for eventID = 1:9%length(expStart)
        eventID
...
matchingPrint
save('mid_80cm_20s.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
