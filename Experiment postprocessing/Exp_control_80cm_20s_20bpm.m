...
data = loadRealExperimentData(struct('datetime',{'2017-10-10 18-20-46'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-10 18-20-46/log_experiment_running_80_2017-10-10_18-20-46.npz']);
...
matchingPrint
similarity
save('control_80cm_20s_20bpm.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
