...
data = loadRealExperimentData(struct('datetime',{'2017-10-03 22-14-52'}, 'ch','80'), [], 2, 13, 10);
...
for strAxCell = {'Y', 'Z'}
    ...
    figure;
    for eventID = 2:13%length(expStart)
        eventID
...
save('fast_40cm_2s.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
