...
data = loadRealExperimentData(struct('datetime',{'2017-10-04 22-11-58'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-04 22-11-58/log_experiment_running_80_2017-10-04_22-11-58.npz']);
...
matchingPrint
save('mid_40cm_20s.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
