...
data = loadRealExperimentData(struct('datetime',{'2017-10-11 20-38-03'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-11 20-38-03/log_experiment_running_80_2017-10-11_20-38-03.npz']);
expStart = exp.tFloat(exp.measured == 1);
expStop = exp.tFloat(exp.measured == 0);
expStop(1:2) = [];
cameraIdxOffset = 0.13;
eventPadding = 0;
...
matchingPrint
similarity
save('human_3.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
