...
data = loadRealExperimentData(struct('datetime',{'2017-10-05 17-47-17'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-05 17-47-17/log_experiment_running_80_2017-10-05_17-47-17.npz']);
expStart = exp.tFloat(exp.measured == 1);
expStop = exp.tFloat(exp.measured == 0);
expStop(1:2) = [];
cameraIdxOffset = 0%;.225;
eventPadding = 0;
...
matchingPrint
save('mid2_20cm_20s.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
