...
data = loadRealExperimentData(struct('datetime',{'2017-10-10 18-02-56'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-10 18-02-56/log_experiment_running_80_2017-10-10_18-02-56.npz']);
...
matchingPrint
similarity
save('control_20cm_20s_80bpm.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
