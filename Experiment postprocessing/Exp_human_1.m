...
data = loadRealExperimentData(struct('datetime',{'2017-10-11 19-57-36'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-11 19-57-36/log_experiment_running_80_2017-10-11_19-57-36.npz']);
...
matchingPrint
similarity
save('human_1.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
