...
data = loadRealExperimentData(struct('datetime',{'2017-10-10 17-55-41'}, 'ch','80'), [], 2, 13, 10);
exp = readNPZ(['/Users/shijiapan/Google Drive/log/80/2017-10-10 17-55-41/log_experiment_running_80_2017-10-10_17-55-41.npz']);
...
matchingPrint
similarity
save('control_10cm_20s_160bpm.mat','uavSig','camSig','fingerprintUAV','fingerprintCAM');
